...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTituloMain = findViewById(R.id.textViewTituloMain);
        MiAdaptador miAdaptador = new MiAdaptador(peliculas);
        rv = findViewById(R.id.reciclerViewMain);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (miAdaptador.getSelectedPos() >= 0) { // Si marco una pasición
                    miAdaptador.setSelectedPos(-1);
                    textViewTituloMain.setText(peliculas.get(pos).getTitulo());
                }
            }
        };
        miAdaptador.setOnClickListener(listener); // Se establece el escuchado del RecycleView
    ...
    public void ActivarDesactivarActionBar(View view) {
    ...
    public void menuLista(MenuItem item) {
        Intent intent = new Intent(MainActivity.this, ActivityLista.class);
        intent.putExtra("PELIS", peliculas);
        System.out.println("Fecha main:" + peliculas.get(1).getFecha());
        startActivityForResult(intent, 2);
    }

    public void menuFavoritas(MenuItem item) {
    ...
    public void menuAñadir(MenuItem item) {
        Toast.makeText(this, "Añadir onClick", Toast.LENGTH_SHORT).show();
    }
